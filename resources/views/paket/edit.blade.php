            ...
            <div class="w-full max-w-2xl">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="bg-blue-600 px-6 py-4">
                        <h3 class="text-2xl font-bold text-white text-center">Edit Data Paket</h3>
                    </div>
                        ...
                        <form action="{{ route('paket.update', $paket->id) }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    id="no_resi" 
                                    name="no_resi" 
                                    value="{{ old('no_resi', $paket->no_resi) }}"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="cod" {{ old('status_paket', $paket->status_paket) == 'cod' ? 'selected' : '' }}>COD</option>
                                    <option value="non cod" {{ old('status_paket', $paket->status_paket) == 'non cod' ? 'selected' : '' }}>Non COD</option>
                                </select>
                                @error('status_paket')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 pt-4 justify-end">
                                ...
                                <a 
                                    ...
                                    class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-3 px-6 rounded-md text-center transition duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                                >
                                    Kembali
                                </a>
                            </div>
